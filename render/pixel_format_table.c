...
const struct wlr_pixel_format_info pixel_format_info[] = {
	...
	{
		.drm_format = DRM_FORMAT_XVYU16161616,
		.bytes_per_block = 8,
		.block_width = 1,
		.block_height = 1,
	},
	{
		.drm_format = DRM_FORMAT_XVYU2101010,
		.bytes_per_block = 4,
		.block_width = 1,
		.block_height = 1,
	},
	...
	{
		.drm_format = DRM_FORMAT_Y0L2,
		.bytes_per_block = 8,
		.block_width = 2,
		.block_height = 2,
	},
	{
		.drm_format = DRM_FORMAT_Y216,
		.bytes_per_block = 8,
		.block_width = 2,
		.block_height = 1,
	},
	{
		.drm_format = DRM_FORMAT_Y410,
		.bytes_per_block = 4,
		.block_width = 1,
		.block_height = 1,
	},
	{
		.drm_format = DRM_FORMAT_Y416,
		.bytes_per_block = 8,
		.block_width = 1,
		.block_height = 1,
	},
	{
		.drm_format = DRM_FORMAT_Y8,
		.bytes_per_block = 1,
		.block_width = 1,
		.block_height = 1,
	},
