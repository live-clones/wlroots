...
enum wlr_linux_drm_syncobj_v1_implicit_sync_flag {
	WLR_LINUX_DRM_SYNCOBJ_V1_IMPLICIT_SYNC_READ = 1 << 0,
	WLR_LINUX_DRM_SYNCOBJ_V1_IMPLICIT_SYNC_WRITE = 1 << 1,
};

/**
 * Register the DMA-BUF release of another buffer for buffer usage.
 ...
 *
 * flags from wlr_linux_drm_syncobj_v1_implicit_sync_flag
 */
