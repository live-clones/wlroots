...
struct wlr_ext_workspace_group_output {
...
static void group_send_details(struct wlr_ext_workspace_group_client_v1 *group_client) {
	...
	struct wlr_ext_workspace_group_output *group_output;
...
static void destroy_group_output(struct wlr_ext_workspace_group_output *group_output) {
...
void wlr_ext_workspace_group_handle_v1_destroy(
	...
	struct wlr_ext_workspace_group_output *group_output, *tmp3;
...
static struct wlr_ext_workspace_group_output *get_group_output(
		struct wlr_ext_workspace_group_handle_v1 *group,
		struct wlr_output *output) {
	struct wlr_ext_workspace_group_output *group_output;
	wl_list_for_each(group_output, &group->outputs, link) {
